...
Route::post('/cells/filter', [HomeController::class, 'filter'])->name('dashboard.cells.filter');
Route::get('/cells/top-models', [HomeController::class, 'getTopModels'])->name('cells.topModels');
